--- src/api/ai/conversationalApi.ts
+++ src/api/ai/conversationalApi.ts
@@ -0,0 +1,220 @@
+import { StreamingTextResponse, Message } from 'ai';
+import ConversationalService from '../../ai/services/ConversationalService';
+import GroqSwarmService from '../../ai/services/GroqSwarmService';
+
+// Initialize services
