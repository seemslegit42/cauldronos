...
export const perspectiveVariants: Variants = {
  hidden: { opacity: 0, rotateX: 10, z: -100 },
  visible: {
    opacity: 1,
    rotateX: 0,
    z: 0,
...
export const transitions = {
  ...
  flipX: flipXVariants,
  flipY: flipYVariants,
  perspective: perspectiveVariants,
  blur: blurVariants,
  elasticScale: elasticScaleVariants,
  swipeLeft: swipeLeftVariants,
  swipeRight: swipeRightVariants,
  pageSlideUp: pageSlideUpVariants,
  pageFadeScale: pageFadeScaleVariants,
  pageFlip: pageFlipVariants,
};
