...
import * as Plugin_0 from 'C:/Users/DevToolsUser/cauldronos/apps/client-portal/src/app.tsx';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : 'C:/Users/DevToolsUser/cauldronos/apps/client-portal/src/app.tsx',
    },
    {
      apply: Plugin_1,
