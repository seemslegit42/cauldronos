...
import moment from 'C:/Users/DevToolsUser/cauldronos/node_modules/.pnpm/moment@2.30.1/node_modules/moment';
import 'C:/Users/DevToolsUser/cauldronos/node_modules/.pnpm/moment@2.30.1/node_modules/moment/locale/zh-cn';
...
export const _LocaleContainer = (props:any) => {
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    if (typeof document !== 'undefined' && intl.messages['CauldronOS Admin Dashboard']) {
      document.title = intl.formatMessage({ id: 'CauldronOS Admin Dashboard' });
    }
    return () => {
