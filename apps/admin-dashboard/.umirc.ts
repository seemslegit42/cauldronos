...
export default defineConfig({
  ...
  alias: {
    '@': './src',
    '@cauldronos/ui': '../../packages/ui/dist',
    '@cauldronos/hooks': '../../packages/hooks/dist',
    '@cauldronos/utils': '../../packages/utils/dist',
    '@cauldronos/agents': '../../packages/agents/dist',
    '@cauldronos/api': '../../packages/api/dist',
  },
  publicPath: '/',
  hash: true,
  history: {
